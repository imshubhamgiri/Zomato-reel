              ...
              <div className="relative p-6 md:p-10">
                <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
                  ...
                  <div className="flex-1 text-center md:text-left">
                    ...
                    <h1 className="text-4xl md:text-5xl font-black mb-3 bg-linear-to-r from-red-600 to-orange-600 bg-clip-text text-transparent">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mt-10 pt-8 border-t-2 border-red-100">
                  <div className="bg-linear-to-br from-red-50 to-red-100 rounded-2xl p-5 text-center hover:scale-105 transition-transform">
                    ...
                    <div className="text-sm font-semibold text-red-800">Menu Items</div>
                  </div>
                  <div className="bg-linear-to-br from-orange-50 to-orange-100 rounded-2xl p-5 text-center hover:scale-105 transition-transform">
                    <div className="text-4xl font-black text-orange-600 mb-2">
                      {foodItems.length * 15}
                    </div>
                    <div className="text-sm font-semibold text-orange-800">Meals Served</div>
                  </div>
                  <div className="bg-linear-to-br from-green-50 to-green-100 rounded-2xl p-5 text-center hover:scale-105 transition-transform">
                    <div className="text-4xl font-black text-green-600 mb-2">
                      {foodItems.length * 8}
                    </div>
                    <div className="text-sm font-semibold text-green-800">Customers</div>
                  </div>
                  <div className="bg-linear-to-br from-yellow-50 to-yellow-100 rounded-2xl p-5 text-center hover:scale-105 transition-transform">
                    <div className="flex items-center justify-center gap-1 mb-2">
                      <div className="text-4xl font-black text-yellow-600">4.5</div>
                      <svg className="w-6 h-6 text-yellow-500" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                      </svg>
                    </div>
                    <div className="text-sm font-semibold text-yellow-800">Rating</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mb-8">
              <div className="flex items-center justify-between mb-8">
                <h2 className="text-3xl font-black text-gray-900 flex items-center gap-3">
                  ...
                  <span className="bg-linear-to-r from-red-600 to-orange-600 bg-clip-text text-transparent">Menu Videos</span>
                </h2>
                <div className="hidden md:flex items-center gap-2 px-4 py-2 bg-red-100 text-red-600 rounded-full font-semibold text-sm">
              ...
              {loading ? (
                      ...
                      <div className="absolute inset-0 bg-linear-to-t from-black via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300">
                        <div className="absolute bottom-0 left-0 right-0 p-5">
                          <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/20">
                            ...
                            <button className="w-full py-2 bg-linear-to-r from-red-600 to-orange-600 hover:from-red-700 hover:to-orange-700 text-white rounded-full text-sm font-bold transition-all shadow-lg">
                              Order Now
                            </button>
                          </div>
                        </div>
                ...
                <div className="text-center py-20 bg-white rounded-3xl shadow-xl border-2 border-dashed border-red-200">
                  ...
                  <p className="text-gray-600 text-xl font-bold mb-2">No videos uploaded yet</p>
                  <p className="text-gray-400 text-sm">Check back later for delicious content!</p>
                </div>
              )}
            </div>
          </>
