      ...
      <div className="bg-gray-900/90 backdrop-blur-md shadow-2xl sticky top-0 z-10 border-b border-red-500/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
          <div className="flex items-center justify-between">
            <Link to="/partner/profile" className="inline-flex items-center text-red-500 hover:text-red-400 font-bold text-lg transition-all hover:gap-3 gap-2">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M10 19l-7-7m0 0l7-7m-7 7h18" />
              </svg>
              Back to Profile
            </Link>
            <h1 className="text-2xl font-black bg-linear-to-r from-red-500 to-orange-500 bg-clip-text text-transparent">
              Add New Dish
            </h1>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className='bg-gray-800 rounded-3xl shadow-2xl overflow-hidden border border-gray-700'>
            ...
            <div className='p-8 md:p-12 grid md:grid-cols-2 gap-8'>
                ...
                <div>
                  ...
                  <div className='relative'>
                    ...
                    <label
                      ...
                      className='flex flex-col items-center justify-center w-full h-64 border-2 border-dashed border-red-500/50 rounded-2xl cursor-pointer bg-gray-900/50 hover:bg-gray-900 hover:border-red-500 transition-all duration-300 group'
                    >
                      {videoPreview ? (
                        ...
                        <div className='text-center p-6'>
                          <svg className="w-16 h-16 text-red-500 mx-auto mb-4 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                          </svg>
                          <p className='text-lg font-bold text-red-500 mb-2'>Click to upload video</p>
              ...
              <div className='space-y-6'>
                {/* Food Name */}
                <div>
                  <label htmlFor="name" className='flex items-center gap-2 text-sm font-bold text-gray-300 mb-3'>
